...
const VideoSection: React.FC = () => {
  return (
    <div className="relative flex flex-col items-center min-h-[40vh] lg:min-h-[70vh] overflow-hidden text-white bg-gradient-to-b from-violet-50 via-white to-white border-b-2">
      ...
      <div className="relative rounded-tr-[6rem] lg:rounded-tr-[12rem] overflow-hidden min-h-[240px] md:min-h-[40vh] xl:min-h-[60vh] w-full">
        <video
